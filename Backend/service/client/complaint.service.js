...
class ComplaintService {
    ...
    const { so_id, clerkId, title, content, photos, rating } = complaintData;

    if (!so_id || !clerkId || !title || !content) {
        throw new Error("Missing required fields: so_id, clerkId, title, content.");
    }
