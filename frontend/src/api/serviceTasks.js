...
export const rescheduleTask = async (taskId, bayId, newStart, newEnd) => {
  const response = await customFetch(
    `/service-tasks/${taskId}/reschedule`,
    {
      ...
      data: {
        bayId,
        start: newStart instanceof Date ? newStart.toISOString() : newStart,
        end: newEnd instanceof Date ? newEnd.toISOString() : newEnd,
      },
    }
  );
