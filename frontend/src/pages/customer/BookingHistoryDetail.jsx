    ...
    if (serviceOrder?.id) {
      checkWarrantyEligibility(serviceOrder.id)
        ...
        .catch((error) => {
          ...
          setWarrantyEligibility({
            eligible: false,
            reason: "Không thể kiểm tra điều kiện bảo hành",
          });
        });
    }
  }, [serviceOrder?.id]);
                        ...
                        {warrantyEligibility &&
                          !warrantyEligibility.eligible && (
                            <div className="text-sm text-amber-600 bg-amber-50 dark:bg-amber-900/20 p-2 rounded">
                              ...
                              {warrantyEligibility.daysRemaining !==
                                undefined &&
                                warrantyEligibility.daysRemaining > 0 && (
                                  <span className="block mt-1">
                                    Còn {warrantyEligibility.daysRemaining} ngày
                                    để bảo hành
                                  </span>
                                )}
                            </div>
                        ...
                        {warrantyEligibility &&
                          warrantyEligibility.eligible && (
                            <div className="text-sm text-green-600 bg-green-50 dark:bg-green-900/20 p-2 rounded">
                              Có thể bảo hành. Còn{" "}
                              {warrantyEligibility.daysRemaining} ngày để yêu
                              cầu bảo hành.
                            </div>
                          )}
                        <div className="flex items-center justify-between">
                    ...
                    <div className="border-t pt-4 mt-4">
                      <div className="space-y-2">
                        ...
                        <div className="text-xs text-muted-foreground space-y-1">
                          <p>
                            • Khách hàng có thể yêu cầu bảo hành trong vòng{" "}
                            <strong>7 ngày</strong> kể từ ngày hoàn thành đơn
                            sửa chữa.
                          </p>
                          <p>
                            • Chỉ áp dụng cho các phụ tùng đã được sửa chữa/thay
                            thế trong đơn.
                          </p>
                          <p>
                            • Mỗi đơn sửa chữa chỉ được bảo hành{" "}
                            <strong>1 lần duy nhất</strong>.
                          </p>
                          <p>
                            • Dịch vụ bảo hành và phụ tùng bảo hành sẽ được miễn
                            phí (giá = 0 đồng).
                          </p>
                          <p>
                            • Thời gian bảo hành: <strong>6 tháng</strong> kể từ
                            ngày bảo hành.
                          </p>
                        </div>
                      </div>
